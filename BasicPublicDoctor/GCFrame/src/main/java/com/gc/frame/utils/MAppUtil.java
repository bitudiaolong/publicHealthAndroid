...
import com.gc.frame.entity.AppInfo;
...
public class MAppUtil {
	 ...
	 * @throws
	 */
	public static AppInfo getApp(Context context, String packageName)
			throws NameNotFoundException {
		PackageInfo pack = context.getPackageManager().getPackageInfo(
				packageName, 0);
	...
	public static List<AppInfo> getAppList(Context context) {
		...
		for (PackageInfo packinfo : packages) {
			...
			if ((app.flags & ApplicationInfo.FLAG_SYSTEM) == 0) {
				apk.setName(app.loadLabel(context.getPackageManager())
						.toString());
	...
	public static long getRxBytes(Context context) {
		...
		try {
			...
			Method method = clazz.getMethod("getUidRxBytes",
					new Class[] { Integer.TYPE });
			rxbytes = ((Long) method.invoke(clazz,
					new Object[] { Integer.valueOf(uid) })).longValue();
		} catch (Exception e) {
			rxbytes = -2L;
		}
		return rxbytes;
	...
	public static long getTxBytes(Context context) {
		...
		try {
			Class clazz = Class.forName("android.net.TrafficStats");
			Method method = clazz.getMethod("getUidTxBytes",
					new Class[] { Integer.TYPE });
			txbytes = ((Long) method.invoke(clazz,
					new Object[] { Integer.valueOf(uid) })).longValue();
		} catch (Exception e) {
			txbytes = -2L;
		}
