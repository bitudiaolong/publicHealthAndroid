 ...
 */
package tv.gagc.basecameraui.style1.camera;
...
import tv.gagc.basecameraui.R;
import tv.gagc.basecameraui.style1.crop.CropView;
import tv.gagc.basecameraui.style1.crop.FrameOverlayView;
import tv.gagc.basecameraui.style1.idcardquality.IDcardQualityProcess;

public class CameraActivity extends Activity {

    public static final String KEY_OUTPUT_FILE_PATH = "outputFilePath"; // 输出路径
    public static final String KEY_CONTENT_TYPE = "contentType";        // 照相机样式 前 后
    public static final String KEY_NATIVE_TOKEN = "nativeToken";
    public static final String KEY_NATIVE_ENABLE = "nativeEnable";      // 是否显示拍照按钮
