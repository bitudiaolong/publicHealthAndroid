...
public class DropListViewHeader extends FrameLayout {
	...
	private DropView mWaterDropView;
	 ...
	 * @param attrs
	 */
	public DropListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		mWaterDropView = (DropView) mContainer
	...
	public void setVisiableHeight(int height) {
		...
		if (mState == STATE.stretch) {
			float pullOffset = (float) mapValueFromRangeToRange(height,
