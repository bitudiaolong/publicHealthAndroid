...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    public interface OnQuantityChangeListener {
		void onQuantityChanged(QuantityView view, int newQuantity,
				boolean programmatically);

		void onLimitReached(QuantityView view);
    }
        ...
        if (v == mButtonAdd) {
            if (quantity + 1 > maxQuantity) {
				if (onQuantityChangeListener != null)
					onQuantityChangeListener.onLimitReached(this);
            } else {
                quantity += 1;
                mTextViewQuantity.setText(String.valueOf(quantity));
                if (onQuantityChangeListener != null)
					onQuantityChangeListener.onQuantityChanged(this, quantity,
							false);
            }
            ...
            if (mTextViewClickListener != null) {
				mTextViewClickListener.onClick(this);
                return;
            }
