...
public class CustemLinnerLayout extends LinearLayout {

	private int position = 0;

	public CustemLinnerLayout(Context context) {
		super(context, null, 0);
		init(context);
	}

	public CustemLinnerLayout(Context context, AttributeSet attrs) {
		super(context, attrs, 0);
		init(context);
	}

	public CustemLinnerLayout(Context context, AttributeSet attrs, int defStyle) {
