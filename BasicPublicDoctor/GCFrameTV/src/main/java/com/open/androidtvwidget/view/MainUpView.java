	...
	public MainUpView(Context context, View view) {
		...
		if (view != null) {
			...
			if (viewGroup != null && this.getParent() != viewGroup) {
				LayoutParams layParams = new LayoutParams(view.getMeasuredWidth(), view.getMeasuredHeight());
...
//					width + padding.right - (mPaddingRect.right), height + padding.bottom - (mPaddingRect.bottom));
			mDrawableUpRect.setBounds(mPaddingRect.left, mPaddingRect.top,
					width - (mPaddingRect.right), height - (mPaddingRect.bottom));
...
//		ObjectAnimator scaleYAnimator = ObjectAnimator.ofInt(new ScaleView(this), "height", mOldHeight, (int)mNewHeight);
		ObjectAnimator scaleXAnimator = ObjectAnimator.ofInt(mScaleView, "width", mOldWidth, (int)mNewWidth);
		ObjectAnimator scaleYAnimator = ObjectAnimator.ofInt(mScaleView, "height", mOldHeight, (int)mNewHeight);
		//
